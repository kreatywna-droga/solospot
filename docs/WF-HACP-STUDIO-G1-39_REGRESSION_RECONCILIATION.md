# TASK WF-HACP-STUDIO-G1-39 — REGRESSION RECONCILIATION
...
- **Pre-Existing Baseline Failures:** 3 tests in `ShapeGrouping.test.ts` (x2) & `ShapeTransform.test.ts` (x1) remain untouched as documented in G1-36, G1-37, and G1-38.
