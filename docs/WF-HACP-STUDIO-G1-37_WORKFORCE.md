# TASK WF-HACP-STUDIO-G1-37 — WORKFORCE SELECTION
...
| **Architect** | Lead Architect (Gemini 3.6 Flash High) | Architectural design, SSOT contract preservation, `VectorViewportController` implementation, bridge integration. |
| **Test Engineer** | Lead Test Engineer | Creation of deterministic unit, E2E, adversarial, and failure injection tests in `VectorViewportG137.test.ts`. |
