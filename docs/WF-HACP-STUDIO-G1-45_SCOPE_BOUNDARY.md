# WF-HACP-STUDIO-G1-45 Scope Boundary Policy

## Mandatory Scope Isolation Rules
- Milestone: `WF-HACP-STUDIO-G1-45-NIGHT-SHIFT-LEVEL-7`
...
- Directly required vector governance documentation (`docs/WF-HACP-STUDIO-G1-45_*.md`)
...
3. DOCUMENT incident in `docs/WF-HACP-STUDIO-G1-45_SCOPE_AUDIT.md`.
