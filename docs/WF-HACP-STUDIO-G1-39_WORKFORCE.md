# TASK WF-HACP-STUDIO-G1-39 — WORKFORCE SELECTION
...
| **Architect** | Lead Architect (Gemini 3.6 Flash High) | Architectural contract, selection & transform engine design, `VectorEditingEngine` and `VectorWorkspaceController` implementation. |
| **Test Engineer** | Lead Test Engineer | Creation of deterministic unit, integration, E2E, adversarial, and failure injection tests in `VectorTransformG139.test.ts`. |
