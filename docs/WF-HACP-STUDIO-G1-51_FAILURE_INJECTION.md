# WF-HACP-STUDIO-G1-51 Failure Injection Matrix

| ID | Attack Vector | Expected Result | Observed Result | Status |
|---|---|---|---|---|
| FI-01 | Corrupted edge DTO (null targetId) | Graceful recovery / bypass | Handled cleanly | PASS |
