# WF-HACP-STUDIO-G1-44 Scope Boundary Policy

## Mandatory Scope Isolation Rules
- Milestone: `WF-HACP-STUDIO-G1-44`
...
- Directly required vector governance documentation (`docs/WF-HACP-STUDIO-G1-44_*.md`)
...
3. DOCUMENT incident in `docs/WF-HACP-STUDIO-G1-44_SCOPE_AUDIT.md`.
