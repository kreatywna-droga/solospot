...
function FlowStepsSection() {
  ...
  return (
    <section id="features" className="relative py-20 px-6 sm:px-8 lg:px-12 max-w-7xl mx-auto bg-transparent">
...
function PlatformArchitecture() {
  ...
  return (
    <section id="architecture" className="relative py-20 px-6 sm:px-8 lg:px-12 max-w-7xl mx-auto bg-transparent">
      <div className="max-w-2xl">
        <div className="mb-8">
