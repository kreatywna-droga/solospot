...
const LOCAL_FALLBACK_POSTER = '/hero-cinematic-poster.png'
...
export function CinematicScrollHero({ onExploreClick }: CinematicScrollHeroProps) {
  ...
  // Track progress and update video currentTime imperatively
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 pt-28 lg:pt-36 flex-1 flex flex-col justify-center">
          <div className="max-w-2xl">
            ...
            <motion.div
              ...
              className="mt-12 sm:mt-14 pt-8 border-t border-white/[0.08] flex items-center gap-6 sm:gap-10"
            >
              <div>
        ...
        <div
          ...
          className="absolute right-8 sm:right-12 bottom-8 z-30 flex flex-col items-center gap-3 transition-opacity duration-300"
        >
        ...
        <div className="relative z-10 w-full border-t border-white/[0.06] bg-[#080B10]/80 backdrop-blur-md py-4 sm:py-5">
