...
export function SaveExperienceModal({
  ...
  return (
    <div className="fixed inset-0 z-[1200] flex items-center justify-center bg-black/85 backdrop-blur-md p-4 animate-in fade-in select-none">
      <div
        className="w-full max-w-xl bg-[#171722] border border-[#2c2c3e] rounded-2xl shadow-2xl flex flex-col overflow-hidden text-white"
      ...
      >
        ...
        <form onSubmit={handleSave} className="p-6 space-y-4">
          ...
          {/* Mini preview */}
          <div className="rounded-xl overflow-hidden border border-[#2a2a3c] bg-[#090910] p-2">
          ...
          {/* Footer Actions */}
          <div className="pt-3 border-t border-[#272738] flex items-center justify-end gap-2.5">
            <button
              type="button"
              onClick={onClose}
