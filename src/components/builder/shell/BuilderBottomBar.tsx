...
export function BuilderBottomBar() {
  ...
  return (
    <div className="h-10 flex items-center justify-between px-4 border-t border-[#2E2E33]
      ...
      <div className="flex items-center gap-1">
        ...
        <div className="relative group">
          ...
          <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-1 hidden group-hover:block">
            <div className="bg-[#202024] border border-[#2E2E33] rounded-xl p-1 shadow-2xl flex items-center gap-0.5">
              {zoomPresets.map(p => (
                <button
                  key={p.label}
