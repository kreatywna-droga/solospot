...
export function BuilderLeftSidebar({ activeTab, onTabChange, width = 320 }: BuilderLeftSidebarProps) {
  ...
  return (
    ...
    >
      {/* Vertical tab strip — 50% larger than 20px, icons centered vertically */}
      <div className="w-[30px] bg-[#18181B] border-r border-[#2E2E33] flex flex-col items-center justify-center gap-1 flex-shrink-0">
        {TABS.map(tab => (
          <button
            key={tab.id}
