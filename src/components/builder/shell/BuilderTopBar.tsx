...
export function BuilderTopBar({
  ...
  return (
    <>
      <div className="h-14 flex items-center justify-between px-4 border-b border-[#44444B]
        ...
        <div className="flex items-center gap-3 min-w-0">
          <Link
            ...
            className="flex items-center justify-center w-9 h-9 rounded-xl
                       bg-[#202024] hover:bg-[#2E2E33] border border-[#3A3A40]
          ...
          <div className="min-w-0">
            ...
            <div className="flex items-center gap-2 mt-0.5">
              ...
              <button
                ...
                className="flex items-center gap-1 px-1.5 py-0.5 rounded bg-[#202024] hover:bg-[#2E2E33] border border-[#3A3A40] text-[10px] text-zinc-300 hover:text-[#D9A86C] transition-all"
        ...
        <div className="flex items-center gap-3 flex-shrink-0">
          ...
          {/* Viewport */}
          <div className="flex items-center gap-0.5 bg-[#202024] rounded-xl p-0.5 border border-[#3A3A40]">
          ...
          <button
            onClick={onSave}
            disabled={saving}
            className="flex items-center gap-2 px-2.5 py-1.5 rounded-xl bg-[#202024] border border-[#3A3A40]
          ...
          <button
            ...
            className="flex items-center gap-1 px-2 py-1.5 rounded-lg bg-[#202024] border border-[#3A3A40]
...
function CommandPaletteModal({ onClose }: { onClose: () => void }): React.ReactElement {
  ...
  return (
    ...
    >
      <div
        className="w-full max-w-xl bg-[#2A2A2F] border border-[#44444B] rounded-2xl shadow-2xl overflow-hidden"
        onClick={e => e.stopPropagation()}
      >
        <div className="flex items-center gap-3 px-4 py-3 border-b border-[#3A3A40]">
