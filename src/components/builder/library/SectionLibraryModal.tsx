  ...
  const renderSectionCard = (template: SectionTemplateItem) => {
    ...
    return (
      ...
      >
        ...
        <div
          className="relative w-full cursor-pointer overflow-hidden group/preview bg-[#18181B] p-3"
              ...
              <div className="flex items-center bg-[#202024] p-1 rounded-xl border border-[#1F1F24]/40">
                <button
                  ...
                  className={`flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-bold transition-all ${
                    viewMode === 'grid' ? 'bg-[#D9A86C] text-white shadow' : 'text-zinc-400 hover:text-white'
                  }`}
                ...
                <button
                  ...
                  className={`flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-bold transition-all ${
                    viewMode === 'accordion' ? 'bg-[#D9A86C] text-white shadow' : 'text-zinc-400 hover:text-white'
                  }`}
                ...
                {groupedCategories.map((group) => {
                  ...
                  return (
                    <div key={group.id} className="border border-[#1F1F24] rounded-2xl bg-[#202024] overflow-hidden shadow-lg">
                      ...
                      {isExpanded && (
                        <div className="p-6 grid grid-cols-1 xl:grid-cols-2 gap-6 bg-[#18181B]">
      ...
      {previewModalTemplate && (
        <div className="fixed inset-0 z-[1100] flex items-center justify-center bg-black/90 backdrop-blur-md p-4 animate-in fade-in duration-150">
          <div className="w-full max-w-6xl max-h-[92vh] bg-[#18181B] border border-[#1F1F24] rounded-2xl shadow-2xl flex flex-col overflow-hidden text-white">
                ...
                {([
                  ...
                  <button
                    ...
                    className={`flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium transition-all ${
                      previewViewport === vp ? 'bg-[#D9A86C] text-white shadow font-bold' : 'text-zinc-400 hover:text-white'
                    }`}
                  >
                    <Icon className="w-3.5 h-3.5" />
                    <span>{label}</span>
            ...
            <div className="flex-1 overflow-y-auto p-6 bg-[#18181B] flex items-center justify-center min-h-[420px]">
              <ScaleToFitContainer
