...
export function StoreLifecycleModal({
  ...
  return (
    <div className="fixed inset-0 z-[1000] flex items-center justify-center bg-black/80 backdrop-blur-sm p-4 animate-in fade-in duration-150">
      <div
        className="w-full max-w-lg bg-[#202024] border border-[#1F1F24] rounded-2xl shadow-2xl flex flex-col overflow-hidden text-white"
      ...
      >
        ...
        <div className="p-6 space-y-6 bg-[#202024]">
          ...
          <div className="p-4 rounded-xl bg-[#202024] border border-[#1F1F24] space-y-4">
                  ...
                  <button
                    ...
                    className={`flex items-center gap-1.5 px-4 py-1.5 rounded-xl text-xs font-bold transition-all ${
                      deleteInput.trim() === storeName.trim()
                        ...
                        : 'bg-[#202024] text-zinc-500 cursor-not-allowed border border-[#1F1F24]'
                    }`}
                  >
                    {deleting ? (
                      <RefreshCw className="w-3.5 h-3.5 animate-spin" />
