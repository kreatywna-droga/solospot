        ...
        <div className="flex-1 overflow-y-auto p-6 bg-[#18181B]">
            ...
            loading ? (
              ...
              <div className="flex flex-col items-center justify-center py-16 text-center border border-dashed border-white/[0.08] rounded-2xl bg-white/[0.01]">
                ...
                <button
                  ...
                  className="px-4 py-2 rounded-xl bg-[#D9A86C] hover:bg-[#C99A4A] text-white text-xs font-bold transition-all"
                >
                  Wgraj pierwszy plik
                </button>
              </div>
                ...
                {filteredAssets.map(asset => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {isSelected && (
                        <div className="absolute top-1.5 right-1.5 w-5 h-5 rounded-full bg-[#D9A86C] text-white flex items-center justify-center shadow-md">
                  ...
                  {filteredLibrary.map((item: UniversalAsset) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        {isSelected && (
                          <div className="absolute top-2 right-2 w-5 h-5 rounded-full bg-[#D9A86C] text-white flex items-center justify-center shadow-md z-10">
                            <Check className="w-3 h-3" />
                          </div>
                        )}
          ...
          {activeTab === 'upload' && (
            <div
              ...
              className="border-2 border-dashed border-white/20 hover:border-[#D9A86C]/60 rounded-2xl p-12 text-center cursor-pointer transition-colors bg-white/[0.02] flex flex-col items-center justify-center h-64"
            >
              {uploading ? (
