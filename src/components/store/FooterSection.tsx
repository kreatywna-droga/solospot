...
export function FooterSection({ section, theme, storeName }: SectionComponentProps) {
  return (
    <footer
      className="py-12 px-4 text-white/80"
      style={{ backgroundColor: theme.primaryColor, fontFamily: theme.font }}
    >
      <div className="max-w-7xl mx-auto">
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          <div>
            <h4 className="font-bold text-white mb-3">{storeName}</h4>
            <p className="text-sm text-white/60">© 2026 Wszelkie prawa zastrzeżone.</p>
          </div>
          <div>
