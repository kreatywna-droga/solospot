  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-3xl mx-auto">
        ...
        {config.subtitle && (
          <p className="text-lg lg:text-xl text-white/80 mb-8 max-w-xl mx-auto">
            {config.subtitle}
          </p>
        )}
        {config.cta && (
          <button
            className="px-8 py-4 rounded-full bg-white text-lg font-bold transition-all hover:scale-105"
