...
export const additionalColorPalettes: ColorPalette[] = [
  ...
  createColorPalette('cool-glacier', 'Cool Glacier', 'Cool Neutral', '#1E6FA8', '#5BB3E8', '#A8D8F0', '#F0F8FF', '#E3F2FD', '#0D2B45', '#5BB3E8', '#C5DCE8', '#1E6FA8', '#22C55E', '#F59E0B', '#EF4444', 92, 'AAA', ['wellness','spa','technology'], ['cool','airy','calm'], ['spa sites','wellness apps'], ['luxury','restaurant']),
  createColorPalette('creative-acid', 'Creative Acid', 'Creative', '#B8FF00', '#00E676', '#FF6D00', '#0A0A0A', '#141414', '#F5F5F5', '#B8FF00', '#333333', '#B8FF00', '#22C55E', '#F59E0B', '#EF4444', 90, 'AAA', ['creative-agency','advertising','fashion'], ['energetic','fresh','bold'], ['campaign sites','streetwear'], ['medical','law','finance']),
  createColorPalette('cyber-violet', 'Violet Cyber', 'Cyber', '#7C3AED', '#A78BFA', '#F472B6', '#0B0618', '#150E2A', '#E9E4FF', '#7C3AED', '#312E81', '#A78BFA', '#22C55E', '#F59E0B', '#EF4444', 88, 'AA', ['gaming','creative','technology'], ['futuristic','bold','neon'], ['gaming sites','creator brands'], ['medical','education','law']),
  createColorPalette('dark-forest-noir', 'Forest Noir', 'Dark', '#064E3B', '#059669', '#34D399', '#022C22', '#0A1F1A', '#ECFDF5', '#059669', '#065F46', '#10B981', '#22C55E', '#F59E0B', '#EF4444', 94, 'AAA', ['technology','gaming','eco'], ['premium','green-glow','dark'], ['devtools','crypto','eco tech'], ['pastel','kids','bright']),
  createColorPalette('desert-clay-warm', 'Desert Clay', 'Desert', '#C2410C', '#EA580C', '#FB923C', '#FFF7ED', '#FFEDD5', '#7C2D12', '#EA580C', '#FDBA74', '#C2410C', '#22C55E', '#F59E0B', '#EF4444', 87, 'AA', ['restaurant','construction','travel'], ['grounded','warm','earthy'], ['southwest brands','farm-to-table'], ['tech','minimal','medical']),
  createColorPalette('editorial-newsprint', 'Editorial Newsprint', 'Editorial', '#111111', '#DC2626', '#B91C1C', '#FAFAF7', '#F0EFE8', '#111111', '#6B7280', '#E5E5E0', '#DC2626', '#22C55E', '#F59E0B', '#EF4444', 96, 'AAA', ['publishing','media','law'], ['print','serious','authoritative'], ['news sites','magazines'], ['pastel','playful','kids']),
  createColorPalette('fashion-sand', 'Fashion Sand', 'Fashion', '#A89279', '#6B5B4B', '#C4A882', '#F7F3EE', '#EDE6DC', '#2F2A24', '#A89279', '#D6C9B8', '#6B5B4B', '#22C55E', '#F59E0B', '#EF4444', 91, 'AAA', ['fashion','beauty','photography'], ['editorial','premium','neutral'], ['lookbooks','editorial'], ['neon','gaming','bold']),
  createColorPalette('hospitality-brass', 'Hospitality Brass', 'Hospitality', '#8A7350', '#B8956A', '#D4AF37', '#FAF6F0', '#F0E8D8', '#2C2416', '#8A7350', '#E0D4B8', '#B8956A', '#22C55E', '#F59E0B', '#EF4444', 90, 'AAA', ['hotel','restaurant','luxury'], ['refined','classic','warm'], ['boutique hotels','fine dining'], ['tech','neon','minimal']),
  createColorPalette('luxury-onyx', 'Luxury Onyx', 'Luxury', '#0A0A0A', '#1C1917', '#D4AF37', '#050505', '#141414', '#F5F5F0', '#D4AF37', '#292524', '#D4AF37', '#22C55E', '#F59E0B', '#EF4444', 97, 'AAA', ['luxury','hotel','fashion'], ['premium','dark','elegant'], ['luxury brands','jewelry'], ['pastel','kids','bright']),
  createColorPalette('medical-mint', 'Medical Mint', 'Medical', '#0D9488', '#2DD4BF', '#6EE7B7', '#F0FDFA', '#CCFBF1', '#134E4A', '#0D9488', '#99F6E4', '#0D9488', '#22C55E', '#F59E0B', '#EF4444', 93, 'AAA', ['medical','dental','wellness'], ['fresh','clean','clinical'], ['clinics','dental'], ['luxury','restaurant','dark']),
  createColorPalette('minimal-warm-grey', 'Minimal Warm Grey', 'Minimal', '#6B6560', '#A8A29E', '#D6D3D1', '#FAF9F7', '#F0EDE8', '#1C1917', '#A8A29E', '#E7E5E0', '#6B6560', '#22C55E', '#F59E0B', '#EF4444', 92, 'AAA', ['photography','architecture','fashion'], ['quiet','restrained','warm'], ['portfolios','galleries'], ['neon','gaming','bold']),
  createColorPalette('nature-meadow', 'Nature Meadow', 'Nature', '#4D7C0F', '#84CC16', '#BBF7D0', '#F7FEE7', '#ECFCCB', '#1A2E05', '#4D7C0F', '#D9F99D', '#4D7C0F', '#22C55E', '#F59E0B', '#EF4444', 91, 'AAA', ['eco','food','travel'], ['organic','fresh','natural'], ['farms','organic food'], ['luxury','dark','tech']),
  createColorPalette('neutral-clay', 'Neutral Clay', 'Warm Neutral', '#8B6F5C', '#A08B7A', '#C4A882', '#F8F4F0', '#F0E8E0', '#3D2B1F', '#8B6F5C', '#D6C9B8', '#8B6F5C', '#22C55E', '#F59E0B', '#EF4444', 89, 'AA', ['real-estate','architecture','hospitality'], ['crafted','earthy','boutique'], ['boutique sites','craft brands'], ['neon','tech','minimal']),
  createColorPalette('ocean-nordic', 'Ocean Nordic', 'Ocean', '#1E4E6B', '#3D8FBF', '#8EC8E8', '#F0F7FA', '#E3F0F7', '#0B1F2E', '#1E4E6B', '#C5DCE8', '#1E4E6B', '#22C55E', '#F59E0B', '#EF4444', 94, 'AAA', ['travel','technology','wellness'], ['nordic','clean','coastal'], ['coastal brands','SaaS'], ['restaurant','luxury','warm']),
  createColorPalette('restaurant-sage', 'Restaurant Sage', 'Restaurant', '#5F7A61', '#8FAE8B', '#C5D5B4', '#F7F6F0', '#EEF0E6', '#2A3327', '#5F7A61', '#D4DFC8', '#5F7A61', '#22C55E', '#F59E0B', '#EF4444', 90, 'AAA', ['restaurant','organic-food','cafe'], ['organic','crafted','calm'], ['farm-to-table','cafes'], ['neon','tech','luxury']),
  createColorPalette('rose-burgundy', 'Burgundy Rose', 'Rose', '#7F1D1D', '#B91C1C', '#F43F5E', '#FFF1F2', '#FFE4E6', '#4C0519', '#7F1D1D', '#FDA4AF', '#B91C1C', '#22C55E', '#F59E0B', '#EF4444', 92, 'AAA', ['beauty','fashion','wine'], ['rich','bold','romantic'], ['beauty brands','wineries'], ['minimal','tech','kids']),
  createColorPalette('sunset-peach', 'Sunset Peach', 'Sunset', '#FB7185', '#FDBA74', '#FDE68A', '#FFF7ED', '#FFEDD5', '#7C2D12', '#FB7185', '#FED7AA', '#FB7185', '#22C55E', '#F59E0B', '#EF4444', 88, 'AA', ['beauty','food','travel'], ['soft','inviting','warm'], ['brunch brands','lifestyle'], ['dark','medical','luxury']),
  createColorPalette('tech-slate-indigo', 'Slate Indigo', 'Technology', '#4338CA', '#6366F1', '#A5B4FC', '#F8FAFC', '#EEF2FF', '#1E1B4B', '#4338CA', '#C7D2FE', '#4338CA', '#22C55E', '#F59E0B', '#EF4444', 95, 'AAA', ['saas','technology','education'], ['product','modern','precise'], ['dashboards','learning apps'], ['restaurant','fashion','pastel']),
  createColorPalette('urban-graphite-orange', 'Graphite Orange', 'Urban', '#374151', '#6B7280', '#F97316', '#F3F4F6', '#E5E7EB', '#111827', '#F97316', '#D1D5DB', '#F97316', '#22C55E', '#F59E0B', '#EF4444', 93, 'AAA', ['construction','sports','urban'], ['industrial','direct','safety'], ['construction sites','sports'], ['luxury','pastel','soft']),
  createColorPalette('wellness-lilac', 'Wellness Lilac', 'Wellness', '#8B5CF6', '#A78BFA', '#DDD6FE', '#F5F3FF', '#EDE9FE', '#2E1065', '#8B5CF6', '#C4B5FD', '#8B5CF6', '#22C55E', '#F59E0B', '#EF4444', 91, 'AAA', ['wellness','beauty','lifestyle'], ['soft','modern','calm'], ['spa apps','lifestyle'], ['restaurant','construction','dark']),
