    ...
    <div className="space-y-3">
          ...
          <div className="relative h-28 w-full bg-black/40 flex items-center justify-center overflow-hidden">
            ...
            <div className="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center gap-2 p-2">
              <button
                ...
                className="px-2.5 py-1.5 rounded-lg bg-[#D9A86C] hover:bg-gold-placeholder-500 text-white text-[11px] font-semibold flex items-center gap-1 shadow-lg transition-all"
              >
      ...
      <div className="grid grid-cols-2 gap-2">
        <button
          ...
          onClick={() => fileInputRef.current?.click()}
          className="flex items-center justify-center gap-1.5 py-2 px-3 rounded-lg bg-[#D9A86C]/20 hover:bg-[#D9A86C]/30 border border-gold-placeholder-500/40 text-gold-placeholder-300 text-xs font-semibold transition-all disabled:opacity-50"
        >
            ...
            <div className="grid grid-cols-3 gap-2 max-h-40 overflow-y-auto pr-1">
              {assets.map((asset) => (
                <button
                  ...
                  className="group relative rounded-lg overflow-hidden border border-white/10 hover:border-gold-placeholder-500 aspect-square bg-black/50"
                >
                  <img
                    src={asset.publicUrl}
      ...
      <div>
        ...
        <select
          ...
          className="w-full bg-[#0a0a14] border border-white/10 rounded-lg px-2.5 py-1.5 text-xs text-white focus:outline-none focus:border-gold-placeholder-500/50 transition-all cursor-pointer"
        >
          {FIT_OPTIONS.map((opt) => (
