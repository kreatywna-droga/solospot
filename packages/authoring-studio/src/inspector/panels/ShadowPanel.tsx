...
/**
 * ShadowPanel — Sprint 7.1 Inspector 2.0 UI Layer
 *
 * Renders shadow-related fields (box-shadow, inset).
 ...
 */
export const ShadowPanel: React.FC<PanelProps> = ({
  fields,
  values,
  onChange,
  renderField,
...
export default React.memo(ShadowPanel);
