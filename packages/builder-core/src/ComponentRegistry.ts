...
export const STANDARD_COMPONENT_DESCRIPTORS: ReadonlyArray<ComponentDescriptor> = [
  ...
  },
  {
    ...
    schema: [
      ...
      selectProp({ key: 'titleSize', label: 'Rozmiar tytułu', required: false, group: 'typography', defaultValue: 'lg', options: [
        { label: 'Mały (text-2xl)', value: 'sm' },
        { label: 'Średni (text-3xl)', value: 'md' },
        { label: 'Duży (text-4xl)', value: 'lg' },
        { label: 'Bardzo duży (text-5xl)', value: 'xl' },
        { label: 'Ogromny (text-6xl)', value: '2xl' },
      ]}),
      selectProp({ key: 'titleWeight', label: 'Grubość tytułu', required: false, group: 'typography', defaultValue: 'bold', options: [
        { label: 'Cienki (300)', value: 'light' },
        { label: 'Normalny (400)', value: 'normal' },
        { label: 'Średni (500)', value: 'medium' },
        { label: 'Pogrubiony (600)', value: 'semibold' },
        { label: 'Bold (700)', value: 'bold' },
      ]}),
      selectProp({ key: 'titleAlign', label: 'Wyrównanie tytułu', required: false, group: 'typography', defaultValue: 'center', options: [
        { label: 'Lewo', value: 'left' },
        { label: 'Środek', value: 'center' },
        { label: 'Prawo', value: 'right' },
      ]}),
      colorProp({ key: 'titleColor', label: 'Kolor tytułu', required: false, group: 'typography', defaultValue: '' }),
    ],
    defaultProps: {
  ...
  },
  {
    ...
    schema: [
      ...
      selectProp({ key: 'titleSize', label: 'Rozmiar nagłówka', required: false, group: 'typography', defaultValue: 'md', options: [
        { label: 'Mały (text-xl)', value: 'sm' },
        { label: 'Średni (text-2xl)', value: 'md' },
        { label: 'Duży (text-3xl)', value: 'lg' },
      ]}),
      selectProp({ key: 'titleWeight', label: 'Grubość nagłówka', required: false, group: 'typography', defaultValue: 'bold', options: [
        { label: 'Normalny (400)', value: 'normal' },
        { label: 'Średni (500)', value: 'medium' },
        { label: 'Pogrubiony (600)', value: 'semibold' },
        { label: 'Bold (700)', value: 'bold' },
      ]}),
      colorProp({ key: 'titleColor', label: 'Kolor nagłówka', required: false, group: 'typography', defaultValue: '' }),
      selectProp({ key: 'bodySize', label: 'Rozmiar tekstu', required: false, group: 'typography', defaultValue: 'md', options: [
        { label: 'Mały (text-sm)', value: 'sm' },
        { label: 'Średni (text-base)', value: 'md' },
        { label: 'Duży (text-lg)', value: 'lg' },
      ]}),
      colorProp({ key: 'bodyColor', label: 'Kolor tekstu', required: false, group: 'typography', defaultValue: '' }),
    ],
    defaultProps: { title: 'O nas', body: 'Jesteśmy marką stawiającą na jakość i pasję.', titleSize: 'md', titleWeight: 'bold', titleColor: '', bodySize: 'md', bodyColor: '' },
